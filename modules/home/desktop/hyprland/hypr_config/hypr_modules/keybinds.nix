...
{ vars, ... }:
{
  wayland.windowManager.hyprland.settings = {
    "$mainMod" = "SUPER";
    "$term" = vars.defaultApps.terminal.command;
    "$editor" = vars.defaultApps.editor.command;
    "$file" = vars.defaultApps.fileManager.command;
    "$browser" = vars.defaultApps.browser.command;
    "$menu" = "${vars.defaultApps.launcher.command} --dmenu";
    "$launcher" = vars.defaultApps.launcher.command;
