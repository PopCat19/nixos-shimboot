...
}:
{
  ...
  home.sessionVariables = {
    EDITOR = vars.defaultApps.editor.command; # Default terminal editor.
    VISUAL = vars.defaultApps.editor.command; # Visual editor alias.
    BROWSER = vars.defaultApps.browser.command; # Default web browser.
    TERMINAL = vars.defaultApps.terminal.command;
    FILE_MANAGER = vars.defaultApps.fileManager.command;
