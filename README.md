...
Check [progress and obstacles](https://github.com/PopCat19/nixos-shimboot#progress-and-obstacles) for current progress.

> [!WARNING]  
> ## This is a 'vibecoded' project  
> As mentioned above:  
> **This repository and its codebase is *mostly* generated by a Large-Language Model directed by a non-programmer simpleton (me) who happens to have time and interest to try this sort of thing**.
> 
