...
> **The majority of this codebase was generated by Large-Language Models.**\
> |\
...
# NixOS Shimboot
I like NixOS. I've started this project since no one else released NixOS shimboot until now. This repo took place with flake approach over the existing scripts from [ading2210/shimboot](https://github.com/ading2210/shimboot), which is mostly incompatible to build with a non-FHS distro like NixOS.
...
The reason I initialized this repo from scratch and moved away from [nixos-shimboot-legacy](https://github.com/PopCat19/nixos-shimboot-legacy/tree/qemu-method2) is due to its inherited contributers and commits from [ading2210/shimboot](https://github.com/ading2210/shimboot). Considering the amounts of change that's been made compared to the original repo, I decided to initialize a clean repo to avoid potential misconceptions. I'll keep the original GPLv3 license except for proprietary/unfree chromeos artifacts that's used to shimboot NixOS.
...
If you wish to use this cache your own configuration, add:
```nix
